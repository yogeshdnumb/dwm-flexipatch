...
// #include "/home/yogi/.cache/wal/colors-wal-dwm.h"
...
static const Rule rules[] = {
		...
		RULE(.title = "spterm", .scratchkey = 's', .isfloating = 1, .iscentered = 1)
#elif SCRATCHPADS_PATCH
...
/* modifier                     key            function                argument */
		...
		{MODKEY, XK_s, spawn, sh("pcmanfm")},
		{MODKEY, XK_e, spawn, sh(term " -e nvim")},
		{MODKEY, XK_t, spawn, sh(term " -e lf")},
		{MODKEY, XK_w, spawn, sh(term " -e btop")},
		...
		{MODKEY, XK_F4, spawn, sh("systemctl suspend")},
		...
		{0, XF86XK_MonBrightnessUp, spawn, sh("sudo light -A 5")},
		{0, XF86XK_MonBrightnessDown, spawn, sh("sudo light -U 5")},
#if RIODRAW_PATCH
...
#if TAB_PATCH
		{MODKEY | ControlMask, XK_z, tabmode, {-1}},
#endif // TAB_PATCH
		...
		{MODKEY | ControlMask, XK_minus, togglegaps, {0}},
...
// {MODKEY | Mod4Mask | ShiftMask, XK_9, incrovgaps, {.i = -1}},
		...
		{MODKEY | ControlMask, XK_Right, shiftboth, {.i = +1}}, // note keybinding conflict with nenennenfocusadjacenttag tagandviewtoright placedir
		...
		{MODKEY | ShiftMask, XK_y, xrdb, {.v = NULL}},
#endif // XRDB_PATCH
		...
		{MODKEY | ControlMask, XK_Tab, setscratch, {.v = scratchpadcmd}},
...
// {MODKEY | ShiftMask, XK_period, tagmon, {.i = +1}},
		...
		{MODKEY, XK_semicolon, viewtoleft, {0}},											// note keybinding conflict with focusdir
		{MODKEY, XK_BackSpace, viewtoright, {0}},											// note keybinding conflict with focusdir
		{MODKEY | ShiftMask, XK_semicolon, tagtoleft, {0}},						// note keybinding conflict with shifttag
		{MODKEY | ShiftMask, XK_BackSpace, tagtoright, {0}},					// note keybinding conflict with shifttag
		{MODKEY | ControlMask, XK_semicolon, tagandviewtoleft, {0}},	// note keybinding conflict with placedir
		{MODKEY | ControlMask, XK_BackSpace, tagandviewtoright, {0}}, // note keybinding conflict with placedir
...
/* click                event mask           button          function        argument */
		 ...
		 */
		{ClkClientWin, MODKEY | Mod1Mask, Button1, moveorplace, {.i = 1}},
