...
static const Key keys[] = {
		...
		{MODKEY, XK_e, spawn, SHCMD(TERM " -e yazi")},
		...
		{MODKEY, XK_F5, spawn, SHCMD("systemctl suspend")},
...
// { MODKEY|ShiftMask,             XK_Return,     spawn,                  {.v = termcmd } },
		...
		{MODKEY | ControlMask, XK_Left, inplacerotate, {.i = +2}},	// same as rotatestack
		{MODKEY | ControlMask, XK_Right, inplacerotate, {.i = -2}}, // same as reotatestack
		{MODKEY | ControlMask, XK_Up, inplacerotate, {.i = +1}},
		{MODKEY | ControlMask, XK_Down, inplacerotate, {.i = -1}},
...
// { MODKEY|Mod4Mask|ShiftMask,    XK_9,          incrovgaps,             {.i = -1 } },
...
#endif // ALT_TAB_PATCH
#if SHIFTTAG_PATCH
		{MODKEY | ShiftMask, XK_bracketleft, shifttag, {.i = -1}},	// note keybinding conflict with focusadjacenttag tagtoleft
		{MODKEY | ShiftMask, XK_bracketright, shifttag, {.i = +1}}, // note keybinding conflict with focusadjacenttag tagtoright
...
#if SHIFTVIEW_PATCH
		{MODKEY | ShiftMask | ControlMask, XK_bracketleft, shiftview, {.i = -1}},
		{MODKEY | ShiftMask | ControlMask, XK_bracketright, shiftview, {.i = +1}},
...
#if SHIFTBOTH_PATCH
		{MODKEY | ControlMask, XK_bracketleft, shiftboth, {.i = -1}},	 // note keybinding conflict with focusadjacenttag tagandviewtoleft placedir
		{MODKEY | ControlMask, XK_bracketright, shiftboth, {.i = +1}}, // note keybinding conflict with focusadjacenttag tagandviewtoright placedir
#endif																														 // SHIFTBOTH_PATCH
#if SHIFTSWAPTAGS_PATCH && SWAPTAGS_PATCH
		{MODKEY | Mod1Mask, XK_bracketleft, shiftswaptags, {.i = -1}},
		{MODKEY | Mod1Mask, XK_bracketright, shiftswaptags, {.i = +1}},
		...
		{MODKEY | Mod1Mask, XK_r, togglealttag, {0}},
#endif // BAR_ALTERNATIVE_TAGS_PATCH
#if NAMETAG_PATCH
		{MODKEY | ShiftMask, XK_n, nametag, {0}},
#endif // NAMETAG_PATCH
#if BAR_TAGGRID_PATCH
		{MODKEY | ShiftMask | Mod1Mask, XK_Up, switchtag, {.ui = SWITCHTAG_UP | SWITCHTAG_VIEW}},
		{MODKEY | ShiftMask | Mod1Mask, XK_Down, switchtag, {.ui = SWITCHTAG_DOWN | SWITCHTAG_VIEW}},
		{MODKEY | ShiftMask | Mod1Mask, XK_Right, switchtag, {.ui = SWITCHTAG_RIGHT | SWITCHTAG_VIEW}}, // note keybinding conflict with placedir
		{MODKEY | ShiftMask | Mod1Mask, XK_Left, switchtag, {.ui = SWITCHTAG_LEFT | SWITCHTAG_VIEW}},		// note keybinding conflict with placedir
		...
		{MODKEY || ShiftMask | ControlMask, XK_equal, setborderpx, {.i = 0}},
...
/* click                event mask           button          function        argument */
#if BAR_STATUSBUTTON_PATCH
		{ClkButton, 0, Button1, spawn, SHCMD(TERM)},
#endif // BAR_STATUSBUTTON_PATCH
		...
		{ClkClientWin, MODKEY, Button3, placemouse, {.i = 1}},
#else
